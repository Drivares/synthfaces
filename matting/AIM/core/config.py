...
PRETRAINED_AIMNET_DUTS = REPOSITORY_ROOT_PATH+'matting/pretrained/aimnet_pretrained_duts.pth'
PRETRAINED_AIMNET_MATTING = REPOSITORY_ROOT_PATH+'matting/pretrained/aimnet_pretrained_matting.pth'
PRETRAINED_R34_MP = REPOSITORY_ROOT_PATH+'matting/pretrained/r34mp_pretrained_imagenet.pth.tar'